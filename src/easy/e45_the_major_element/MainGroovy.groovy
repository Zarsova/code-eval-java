...
class MainGroovy {
    static main(argv) {
        //CodeEvalRunner.run(["input/easy/e45_the_major_element.txt"] as String[], Main)
        CodeEvalRunner.run(["92,19,19,76,19,21,19,85,19,19,19,94,19,19,22,67,83,19,19,54,59,1,19,19",
